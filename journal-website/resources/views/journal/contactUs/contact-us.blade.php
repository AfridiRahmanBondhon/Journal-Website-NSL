        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="common_title">
              <span class="d-block">Send a messege</span>
              ...
              <div class="contact-info-item">
                <ul class="list-unstyled">
                  ...
                  <li class="info">
                    ...
                    <p><a href="tel:0000-0000-00-000">{{ $siteSetting->mobile1 ?? '' }}</a></p>
                  </li>
                </ul>
              </div>
              <div class="contact-info-item">
                <ul class="list-unstyled">
                  ...
                  <li class="info">
                    ...
                    <p><a href="mailto:hasan000@yourmail.com">{{ $siteSetting->contact_email ?? '' }}</a></p>
                  </li>
                </ul>
              </div>
              <div class="contact-info-item">
