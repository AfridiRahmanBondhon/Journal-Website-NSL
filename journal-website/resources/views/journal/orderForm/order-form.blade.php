            ...
            <div class="image">
              <!-- <div class="main-image">
                <div class="position-relative">
                  <img src="images/about-shape1.png" alt="" class="img-fluid w-100 shape">
                  <img src="images/about-img3.jpg" alt="about-img3" class="main_image position-absolute">
                </div>
              </div> -->
              <img src="{{asset('journal_resources')}}/images/files-sent-animate.svg" alt="">
            </div>
          </div>
            ...
            <div class="form_main">
              <form action="{{route('order')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="input-group">
                      <label>Organization Name <sup class="text-danger">*</sup></label>
                  ...
                  <div class="col-lg-12">
                    <button type="submit" class="cta d-inline-block">
                      <span class="span">Request Quote</span>
                      <span class="second">
                        <svg width="50px" height="17px" viewBox="0 0 66 43" version="1.1"
