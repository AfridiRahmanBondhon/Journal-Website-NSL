<template>
  <div
    ...
    :style="`background-color: ${
      colors.navbar_color ? colors.navbar_color : databaseColor.navbar_color
    };`"
  >
    <div class="topbar">
      <div class="row">
        <div class="col-lg-6 left-info-col align-self-center">
          <div class="left-info d-flex">
            ...
            <p class="mt-4 text-dark bold">{{ loggedInfo() }}</p>
          </div>
        </div>
          ...
          >
            <div class="profile dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li>
                  <a :href="`${$root.baseurl}/admin/siteSetting/1/edit`"
                    ><i class="fa fa-cog text-aqua"></i>Settings</a
                  >
                </li>
                <li>
                  <a :href="`${$root.baseurl}/admin/admin/${user?.id}`"
